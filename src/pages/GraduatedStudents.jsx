...
const GraduatedStudents = () => {
  ...
  return <main className="admin-page graduates-page">
    ...
    {selected && <div className="admin-modal-overlay"><div className="admin-modal graduate-modal"><button type="button" className="admin-modal-close" aria-label="Close graduate details" onClick={() => setSelected(null)}>×</button><h2>{getName(selected)}</h2><p className="admin-modal-email">{textValue(getEmail(selected))}</p><div className="admin-details-grid">
